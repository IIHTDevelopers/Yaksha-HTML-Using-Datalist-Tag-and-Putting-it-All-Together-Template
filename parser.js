    ...
    for (let outerElement of outerElements) {
        ...
        for (let innerElement of innerElements) {
            ...
            for (let attribute of attributes) {
                if (!innerElement.hasAttribute(attribute)) {
...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'h1', 'form', 'input', 'label', 'datalist']]
};

const htmlFormAttributesTestCase = {
    testCaseName: 'HTML Form Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['form', ['action', 'method']]
};

const htmlInputAttributesTestCase = {
    testCaseName: 'HTML Input Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['input', ['type']]
};

const htmlLabelAttributesTestCase = {
    testCaseName: 'HTML Label Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['label', ['for']]
};

const htmlFormLabelNestedTagsWithAttributesPresenceTestCase = {
    testCaseName: 'Nested Tags with Inner Attributes Presence Test',
    testCaseType: 'boundary',
    testLogic: checkNestedTagsWithInnerAttributesPresence,
    extraParams: ['form', 'label', ['for']]
};

const htmlFormInputNestedTagsWithAttributesPresenceTestCase = {
    testCaseName: 'Nested Tags with Inner Attributes Presence Test',
    testCaseType: 'boundary',
    testLogic: checkNestedTagsWithInnerAttributesPresence,
    extraParams: ['form', 'input', ['type']]
};

const htmlFormTextareNestedTagsWithAttributesPresenceTestCase = {
    testCaseName: 'Nested Tags with Inner Attributes Presence Test',
    testCaseType: 'boundary',
    testLogic: checkNestedTagsWithInnerAttributesPresence,
    extraParams: ['form', 'datalist', ['id']]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlFormAttributesTestCase.testCaseName, htmlFormAttributesTestCase.testCaseType, htmlFormAttributesTestCase.testLogic, htmlFormAttributesTestCase.extraParams);
    handleTestCase(filePath, htmlInputAttributesTestCase.testCaseName, htmlInputAttributesTestCase.testCaseType, htmlInputAttributesTestCase.testLogic, htmlInputAttributesTestCase.extraParams);
    handleTestCase(filePath, htmlLabelAttributesTestCase.testCaseName, htmlLabelAttributesTestCase.testCaseType, htmlLabelAttributesTestCase.testLogic, htmlLabelAttributesTestCase.extraParams);
    handleTestCase(filePath, htmlFormLabelNestedTagsWithAttributesPresenceTestCase.testCaseName, htmlFormLabelNestedTagsWithAttributesPresenceTestCase.testCaseType, htmlFormLabelNestedTagsWithAttributesPresenceTestCase.testLogic, htmlFormLabelNestedTagsWithAttributesPresenceTestCase.extraParams);
    handleTestCase(filePath, htmlFormInputNestedTagsWithAttributesPresenceTestCase.testCaseName, htmlFormInputNestedTagsWithAttributesPresenceTestCase.testCaseType, htmlFormInputNestedTagsWithAttributesPresenceTestCase.testLogic, htmlFormInputNestedTagsWithAttributesPresenceTestCase.extraParams);
    handleTestCase(filePath, htmlFormTextareNestedTagsWithAttributesPresenceTestCase.testCaseName, htmlFormTextareNestedTagsWithAttributesPresenceTestCase.testCaseType, htmlFormTextareNestedTagsWithAttributesPresenceTestCase.testLogic, htmlFormTextareNestedTagsWithAttributesPresenceTestCase.extraParams);
}
